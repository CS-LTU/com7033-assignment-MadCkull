...
async function renderPatients(patients) {
  ...
  patients.forEach((patient, index) => {
    ...
    row.querySelector('[data-field="patient_id"]').textContent =
      "SW" + patient.patient_id;
    ...
    riskBadge.style.color = getRiskColor(patient.stroke_risk);

    row.querySelector('[data-field="date"]').textContent = new Date(
    ...
    editBtn.onclick = (e) => {
      ...
      editPatient(patient.patient_id, row);
    };
